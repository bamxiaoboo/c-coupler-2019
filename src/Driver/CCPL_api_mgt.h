...
#define API_ID_RESTART_MGT_WRITE_IO                     ((int)(0X07000001))
#define API_ID_RESTART_MGT_START_READ_IO                ((int)(0X07000002))
#define API_ID_RESTART_MGT_IS_TIMER_ON                  ((int)(0X07000004))
#define API_ID_RESTART_MGT_READ_ALL                     ((int)(0X07000008))
#define API_ID_RESTART_MGT_READ_INTERFACE               ((int)(0X07000010))
#define API_ID_RESTART_MGT_GET_SETTING                  ((int)(0X07000012))
