...
Runtime_remap_algorithm::Runtime_remap_algorithm(Runtime_remapping_weights *runtime_remapping_weights, Field_mem_info *src_field_instance, Field_mem_info *dst_field_instance, int connection_id)
{
	...
	printf("runtime remapping src grid is %s  %lx", true_src_field_instance->get_field_data()->get_coord_value_grid()->get_grid_name(), true_src_field_instance); 	
	printf("runtime remapping dst grid is %s  %lx", true_dst_field_instance->get_field_data()->get_coord_value_grid()->get_grid_name(), true_dst_field_instance); 
	fflush(NULL);
}
