...
void Decomp_grid_info::register_decomp_grid_fields()
{
    ...
    local_lats = alloc_mem(decomps_info_mgr->search_decomp_info(decomp_name)->get_model_name(), decomp_name, original_grid->get_grid_name(), LAT_GF, 0);
    local_lons = alloc_mem(decomps_info_mgr->search_decomp_info(decomp_name)->get_model_name(), decomp_name, original_grid->get_grid_name(), LON_GF, 0);
    local_masks = alloc_mem(decomps_info_mgr->search_decomp_info(decomp_name)->get_model_name(), decomp_name, original_grid->get_grid_name(), MASK_GF, 0);
    local_nlats = alloc_mem(decomps_info_mgr->search_decomp_info(decomp_name)->get_model_name(), decomp_name, original_grid->get_grid_name(), GRID_LATS_GF, 0);
    local_nlons = alloc_mem(decomps_info_mgr->search_decomp_info(decomp_name)->get_model_name(), decomp_name, original_grid->get_grid_name(), GRID_LONS_GF, 0);
