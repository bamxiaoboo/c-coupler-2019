...
class Remap_weight_of_operator_class
{
    ...
    public: 
        Remap_weight_of_operator_class(Remap_grid_class*, Remap_grid_class*, Remap_operator_basis*);
...
class Remap_weight_of_strategy_class
{
    ...
    public:
        ...
        int get_num_remap_operator_of_weights() { return remap_weights_of_operator_instances.size(); }
        Remap_operator_basis *get_remap_operator_of_weights(int i) { return remap_weights_of_operator_instances[i]->duplicated_remap_operator; }
