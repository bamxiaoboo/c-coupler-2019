...
void IO_mgt::execute(const char*function, Remap_statement_operand **statement_operands, int num_operands)
{
    ...
    if (words_are_the_same(function, FUNCTION_WORD_ADD_NC_FILE) ||
        ...
        if (words_are_the_same(statement_operands[2]->extension_names[0], "SCRIP")) {
            ...
            ((IO_netcdf *) current_IO_object)->write_remap_weights(remap_weights_manager->search_remap_weight_of_strategy(statement_operands[1]->object->object_name, true));
        }
            ...
            ((IO_binary *) current_IO_object)->write_remap_weights(remap_weights_manager->search_remap_weight_of_strategy(statement_operands[1]->object->object_name, true));
        }
