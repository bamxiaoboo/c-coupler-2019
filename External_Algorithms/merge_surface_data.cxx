...
void reset_surface_data(void **buf_src, void **buf_dst, int *length)
{
	...
	EXECUTION_REPORT(REPORT_ERROR,-1, num_src_fields == 0, "the number of input fields of externel function reset_surface_data must be 0");
...
void merge_one_kind_surface_data(void **buf_src, void **buf_dst, int *length)
{
	...
	EXECUTION_REPORT(REPORT_ERROR,-1, num_src_fields == num_dst_fields*2+1, "the number of input fields of externel function merge_one_kind_surface_data must be 2*num_dst_fields+1");
